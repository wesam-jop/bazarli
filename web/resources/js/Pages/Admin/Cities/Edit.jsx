...
import { ArrowLeft, Save, Navigation, LocateFixed } from 'lucide-react';

const DEFAULT_COORDS = { lat: 35.9333, lng: 36.6333 }; // Idlib City default

export default function EditCity({ city, governorates }) {
    ...
    const { data, setData, put, processing, errors } = useForm({
        ...
        center_latitude: city.center_latitude || DEFAULT_COORDS.lat.toString(),
        center_longitude: city.center_longitude || DEFAULT_COORDS.lng.toString(),
        delivery_radius: city.delivery_radius || 10,
    ...
    return (
        <AdminLayout title={t('edit_city')}>
            <Head title={t('edit_city')} />
            ...
            <div className="space-y-6">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h2 className="text-3xl font-bold text-slate-900">{t('edit_city')}</h2>
                        <p className="text-slate-600 mt-1">{city.name_ar}</p>
                    </div>
                </div>
