...
export default function CreateGovernorate({ nextDisplayOrder }) {
    ...
    return (
        <AdminLayout title={t('add_governorate')}>
            <Head title={t('add_governorate')} />
            ...
            <div className="space-y-6">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h2 className="text-3xl font-bold text-slate-900">{t('add_governorate')}</h2>
                        <p className="text-slate-600 mt-1">{t('add_new_governorate') || 'أضف محافظة جديدة إلى النظام'}</p>
                    </div>
                </div>
